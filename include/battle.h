...
public:
   ...
   void setActionsThisTurn(int value) { actionsThisTurn = value; }
  ...
  void setPlayerFirst(bool value) {
      playerfirst = value;
  }
   ...
   void setGameState(
      ...
      gameover = gameOver;
      sherlockAbilityActive = sherlockAbility;
      invisibleAbilityActive = invisibleAbility;
      extraAction = extraAct;
     invisibleStartedOnFog = invisibleFog;
  }
};
